...
console.log("M\xE9dia Aritm\xE9tica Simples: ".concat(averge(3, 6, 10, 4, 2)));
...
console.log("M\xE9dia Aritm\xE9tica Ponderada: ".concat(weightedAverage({
  number: 6,
  weight: 3
}, {
  number: 7,
...
console.log("Media: ".concat(media(2, 5, 56, 4, 12, 9)));
console.log("Media: ".concat(media(14, 13, 4, 5, 2, 9)));
